...
reference-blocks.png (this is block 3).

## Deliverable

- **One transparent PNG, exactly 748 × 1176 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-03-canvas.png` (same 748 × 1176) is the paintable region, traced

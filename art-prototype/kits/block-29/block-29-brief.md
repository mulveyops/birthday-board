...
reference-blocks.png (this is block 29).

## Deliverable

- **One transparent PNG, exactly 536 × 752 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-29-canvas.png` (same 536 × 752) is the paintable region, traced

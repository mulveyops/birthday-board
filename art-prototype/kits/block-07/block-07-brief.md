...
reference-blocks.png (this is block 7).

## Deliverable

- **One transparent PNG, exactly 600 × 372 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-07-canvas.png` (same 600 × 372) is the paintable region, traced

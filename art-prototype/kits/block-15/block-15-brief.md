...
reference-blocks.png (this is block 15).

## Deliverable

- **One transparent PNG, exactly 616 × 404 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-15-canvas.png` (same 616 × 404) is the paintable region, traced

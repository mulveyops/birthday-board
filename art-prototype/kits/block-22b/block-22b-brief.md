...
**You are painting HALF of one city block — the second half of block 22.**
...
- `block-22b-canvas.png` — **the stencil.** The white shape is the real block:
  the part of your painting we keep. Everything outside it is cut away. It is
  the exact size your painting must be.
- `block-22b-context.png` — **orientation only, never a thing to copy.** It shows
...
- `block-22b-layout.png` — **the site plan, and the most important attachment
...
- `block-22b-style-reference.png` — **a texture sample: HOW to paint, never WHAT
...
>
> Identical in size and shape to the attached `block-22b-canvas.png`. This is not a
...
- **One PNG, exactly 580 × 856 px, painted edge to edge.** That is 4× the block's
  final size on the board canvas (145 × 214 px at position x 1033, y 1288 on the
...
- **The white shape in `block-22b-canvas.png` is what you are painting**: the real
...
**Paint in the manner of `block-22b-style-reference.png`** — its brushwork, not its
...
See `block-22b-context.png` — your block outlined in red dashes on the actual base

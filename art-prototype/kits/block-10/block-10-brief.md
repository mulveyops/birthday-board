...
reference-blocks.png (this is block 10).

## Deliverable

- **One transparent PNG, exactly 316 × 316 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-10-canvas.png` (same 316 × 316) is the paintable region, traced

...
reference-blocks.png (this is block 23).

## Deliverable

- **One transparent PNG, exactly 636 × 2028 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-23-canvas.png` (same 636 × 2028) is the paintable region, traced

...
- **Ground anchor: canvas px (1537, -35)** — its main entrance meets the sidewalk here.
- **Paint it about 209 × 92 px** — that is 1.8× its real 17 × 7 m
...
- **Ground anchor: canvas px (1529, 461)** — its main entrance meets the sidewalk here.
- **Paint it about 237 × 148 px** — that is 1.8× its real 19 × 12 m

...
reference-blocks.png (this is block 22).

## Deliverable

- **One transparent PNG, exactly 580 × 1712 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-22-canvas.png` (same 580 × 1712) is the paintable region, traced

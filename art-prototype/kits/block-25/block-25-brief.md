...
reference-blocks.png (this is block 25).

## Deliverable

- **One transparent PNG, exactly 544 × 732 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-25-canvas.png` (same 544 × 732) is the paintable region, traced

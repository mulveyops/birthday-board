...
reference-blocks.png (this is block 18).

## Deliverable

- **One transparent PNG, exactly 544 × 772 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-18-canvas.png` (same 544 × 772) is the paintable region, traced

...
reference-blocks.png (this is block 5).

## Deliverable

- **One transparent PNG, exactly 624 × 384 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-05-canvas.png` (same 624 × 384) is the paintable region, traced

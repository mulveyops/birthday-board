...
reference-blocks.png (this is block 16).

## Deliverable

- **One transparent PNG, exactly 600 × 404 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-16-canvas.png` (same 600 × 404) is the paintable region, traced

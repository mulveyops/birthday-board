...
reference-blocks.png (this is block 8).

## Deliverable

- **One transparent PNG, exactly 616 × 372 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-08-canvas.png` (same 616 × 372) is the paintable region, traced

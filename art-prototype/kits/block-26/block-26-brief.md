...
reference-blocks.png (this is block 26).

## Deliverable

- **One transparent PNG, exactly 660 × 760 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-26-canvas.png` (same 660 × 760) is the paintable region, traced

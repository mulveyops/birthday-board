...
reference-blocks.png (this is block 28).

## Deliverable

- **One transparent PNG, exactly 540 × 752 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-28-canvas.png` (same 540 × 752) is the paintable region, traced

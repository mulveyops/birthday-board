...
reference-blocks.png (this is block 14).

## Deliverable

- **One transparent PNG, exactly 600 × 408 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-14-canvas.png` (same 600 × 408) is the paintable region, traced

...
reference-blocks.png (this is block 21).

## Deliverable

- **One transparent PNG, exactly 540 × 1704 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-21-canvas.png` (same 540 × 1704) is the paintable region, traced
...
- **Ground anchor: canvas px (85, 39)** — its main entrance meets the sidewalk here.
- **Paint it about 218 × 209 px** — that is 1.8× its real 17 × 17 m
  footprint, and roughly 40% of the block's width. Oversized on purpose.

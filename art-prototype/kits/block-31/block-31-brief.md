...
reference-blocks.png (this is block 31).

## Deliverable

- **One transparent PNG, exactly 660 × 748 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-31-canvas.png` (same 660 × 748) is the paintable region, traced

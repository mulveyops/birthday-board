...
reference-blocks.png (this is block 27).

## Deliverable

- **One transparent PNG, exactly 564 × 664 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-27-canvas.png` (same 564 × 664) is the paintable region, traced

...
reference-blocks.png (this is block 13).

## Deliverable

- **One transparent PNG, exactly 868 × 948 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-13-canvas.png` (same 868 × 948) is the paintable region, traced
...
1. **The Standard Tavern** — anchor at canvas px **(85, 84)** (the ground point of its entrance/front). Corner tavern — real Brady-area bar. Paint as a 2-story corner tavern with a modest sign band reading "The Standard Tavern" (readable text allowed for this name).

2. **Pete's Pub** — anchor at canvas px **(641, 895)** (the ground point of its entrance/front). Corner tavern — real Brady-area bar. Paint as a 2-story corner tavern with a modest sign band reading "Pete's Pub" (readable text allowed for this name).

3. **Hi Hat Garage** — anchor at canvas px **(787, 896)** (the ground point of its entrance/front). Corner tavern — real Brady-area bar. Paint as a 2-story corner tavern with a modest sign band reading "Hi Hat Garage" (readable text allowed for this name).

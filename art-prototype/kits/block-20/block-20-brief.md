...
reference-blocks.png (this is block 20).

## Deliverable

- **One transparent PNG, exactly 664 × 772 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-20-canvas.png` (same 664 × 772) is the paintable region, traced

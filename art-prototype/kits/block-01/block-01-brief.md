...
**You are painting one city block: block 1.** It is bounded by real streets,
it contains real buildings, and your painting drops into the hole where that
block sits.

## What is attached

- `block-01-canvas.png` — **the stencil.** The white shape is the real block:
  the part of your painting we keep. Everything outside it is cut away. It is
  the exact size your painting must be.
- `block-01-context.png` — **orientation only, never a thing to copy.** It shows
...
- `block-01-layout.png` — **the site plan, and the most important attachment
...
- **The white shape in `block-01-canvas.png` is what you are painting**: the real
...
**Paint in the manner of `block-01-style-reference.png`** — its brushwork, not its

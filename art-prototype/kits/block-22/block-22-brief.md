...
- `block-22-layout.png` — **the plan: where the landmark goes.** The block's shape
...
- **Centre it on canvas px (573, 140)**, facing its street. This is a tight corner of the block — turn the building to follow its
...
- [ ] **Hosed on Brady** is in the painting, near canvas px (573, 140), roughly 158 × 88 px, and obviously bigger and more interesting than the houses around it.

...
reference-blocks.png (this is block 12).

## Deliverable

- **One transparent PNG, exactly 528 × 948 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-12-canvas.png` (same 528 × 948) is the paintable region, traced

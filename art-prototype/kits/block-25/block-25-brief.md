...
**You are painting one city block: block 25.** It is bounded by real
...
- `block-25-context.png` — **orientation only, never a thing to copy.** It shows
...
- `block-25-layout.png` — **the site plan, and the most important attachment
...
- `block-25-style-reference.png` — **a texture sample: HOW to paint, never WHAT
...
- **The white shape in `block-25-canvas.png` is what you are painting**: the real
...
**Paint in the manner of `block-25-style-reference.png`** — its brushwork, not its

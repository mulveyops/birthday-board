...
reference-blocks.png (this is block 19).

## Deliverable

- **One transparent PNG, exactly 544 × 788 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-19-canvas.png` (same 544 × 788) is the paintable region, traced

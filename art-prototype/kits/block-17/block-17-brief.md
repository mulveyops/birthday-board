...
reference-blocks.png (this is block 17).

## Deliverable

- **One transparent PNG, exactly 608 × 848 px.** That is 4× the block's
...
- **Paint only inside the white area of the stencil.** The attached
  `block-17-canvas.png` (same 608 × 848) is the paintable region, traced
